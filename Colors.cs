...
namespace PoorMansAmbilight {
	...
	struct HSVColor {
		...
		public static implicit operator PixelColor(HSVColor HSV) {
			double H = HSV.H % 360;
			...
			if (S <= 0.0) {
				...
				G = V;
				B = V;
				return new PixelColor((byte)(R * 255), (byte)(G * 255), (byte)(B * 255));
			}
		...
		public static implicit operator HSVColor(PixelColor Col) {
